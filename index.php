...
<html class="sidebar_hover  no-js" lang="en"><head>
		<meta charset="utf-8">
		<title>PT Petrokimia Gresik (LK3)</title>
	  ...
	  <div class="container">
				...
				<li class="dropdown"> 
                    ...
                    data-target="#" href="../../page.html">
                        <div class="title">
                            ...
                            <span class="subtitle"><?php #echo"$_SESSION[leveluser]"; ?></span>
                        </div>
                        <span class="icon">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                        <li><a href="?hlm=<?php echo enkrip('admin');?>" class="menu"><i class=" icon-cog"></i>Settings</a></li>
		...
		<?php 
			...
			switch ($hlm){
				...
				break;
				case 'mpekerja':
					include 'mpekerja.php';
				break;
				case 'mbagian':
					include 'mbagian.php';
				break;
				case 'mjabatan':
					include 'mjabatan.php';
				break;
				case 'mdepartment':
					include 'mdepartment.php';
				break;
				case 'mshift':
					include 'mshift.php';
				break;
				case 'mstatuskerja':
					include 'mstatuskerja.php';
				break;
				case 'mjkecel':
					include 'mjkecel.php';
				break;
				case 'mjcidera':
					include 'mjcidera.php';
				break;
				case 'mbagtubuh':
					include 'mbagtubuh.php';
				break;
				case 'mnilairesiko':
					include 'mnilairesiko.php';
				break;
				case 'mkatinvestigasi':
					include 'mkatinvestigasi.php';
				break;
				case 'mjlampiran':
					include 'mjlampiran.php';
				break;
				case 'mtipedampak':
					include 'mtipedampak.php';
				break;
				case 'mproduk':
					include 'mproduk.php';
				break;
				...
				break;
				case 'msamplingemisi':
					include 'msamplingemisi.php';
				case 'mtempatsampling':
					include 'mtempatsampling.php';
				break;
				case 'msafetyp':
					include 'msafetyp.php';
				break;
				case 'tkecelakaan':
					include 'tkecelakaan.php';
				break;
				case 'tkecelakaanakhir':
					include 'tkecelakaanakhir.php';
				break;
				case 'temisi':
					include 'temisi.php';
				break;
				case 'tsafetyp':
					include 'tsafetyp.php';
				break;
				case 'lkecelakaan':
					include 'lkecelakaan.php';
				break;
				case 'lemisi':
					include 'lemisi.php';
				break;
				case 'lsafetyp':
					include 'lsafetyp.php';
				break;
				case 'suser':
					include 'suser.php';
				break;
				case 'shakakses':
					include 'shakakses.php';
				break;
				case 'slevel':
					include 'slevel.php';
				break;
		...
		<!-- End #container -->
	  <div id="footer">
		<p> &copy; PT. Petrokimia Gresik @ 2013 </p>
