      <div class="row-fluid">
        <div class="box ">
          <div class="title">
            <h4> <span>Data Master - Department <small>(PT. Petrokimia Gresik)</small></span> </h4>
          </div>
          <!-- End .title -->
            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              ...
              <tbody>
                <tr>
                  ...
                  <td >14</td>
                  <td class="ms"><div class="btn-group1"> <a class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
                <tr>
                  <td><label class="checkbox ">
                      <input type="checkbox">
